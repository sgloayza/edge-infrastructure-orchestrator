...
echo -e "${BOLD}[1/4] Levantando contenedor MongoDB Primario (Puerto 27027)...${RESET}"
...
echo -e "${BOLD}[2/4] Levantando contenedor MongoDB Histórico de Auditoría (Puerto 27028)...${RESET}"
